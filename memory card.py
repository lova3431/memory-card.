...
questions_list.append( Question("Столиця Франції?", "Париж", "Берлін", "Лондон", "Рим") )
questions_list.append( Question("Скільки днів у тижні?", "7", "5", "6", "8") )
...
def next_question():
    ...
    q = questions_list[cur_question]   # Беремо поточне питання
